...
public class MainActivity extends Activity implements TouchListener, DialogInterface.OnClickListener, SystemListener {
	...
	public void handleError(final String errorMsg, final Throwable t) {
		...
		runOnUiThread(new Runnable() {
				@Override
				public void run() {
					AlertDialog dialog = new AlertDialog.Builder(MainActivity.this) // .setIcon(R.drawable.alert_dialog_icon)
						.setTitle(finalTitle).setPositiveButton("Kill", MainActivity.this).setMessage(finalMsg).create();
					dialog.show();
				}
			});
	}
			...
			switch (evt.getType()) {
				case KEY_UP:
					runOnUiThread(new Runnable() {
							...
							public void run() {
								AlertDialog dialog = new AlertDialog.Builder(MainActivity.this) // .setIcon(R.drawable.alert_dialog_icon)
									.setTitle(exitDialogTitle).setPositiveButton("Yes", MainActivity.this).setNegativeButton("No", MainActivity.this).setMessage(exitDialogMessage).create();
								dialog.show();
							}
						});
					break;
